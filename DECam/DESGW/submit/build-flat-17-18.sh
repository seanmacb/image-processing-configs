...
#SBATCH -o /shares/soares-santos.physik.uzh/fitsFiles/calibs/logs/cpFlat_17-18_%j.out
#SBATCH -e /shares/soares-santos.physik.uzh/fitsFiles/calibs/logs/cpFlat_17-18_%j.err
...
LOGFILE=$LOGDIR/cpFlat_17-18.log
...
-o DECam/calib/template/flat/17-18 \
-p $CP_PIPE_DIR/pipelines/DECam/cpFlat.yaml \
-d "instrument='DECam' AND exposure.observation_type='dome flat' AND exposure.day_obs >= 20170000 AND exposure.day_obs <= 20189999" \
2>&1 | tee -a $LOGFILE
date | tee -a $LOGFILE
