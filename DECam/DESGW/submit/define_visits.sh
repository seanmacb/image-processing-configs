...
#SBATCH -o /shares/soares-santos.physik.uzh/fitsFiles/calibs/logs/define_visits_%j.out
#SBATCH -e /shares/soares-santos.physik.uzh/fitsFiles/calibs/logs/define_visits_%j.err
