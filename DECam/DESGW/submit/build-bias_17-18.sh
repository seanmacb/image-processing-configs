...
#SBATCH -o /shares/soares-santos.physik.uzh/fitsFiles/calibs/logs/cpBias_17-18_%j.out
#SBATCH -e /shares/soares-santos.physik.uzh/fitsFiles/calibs/logs/cpBias_17-18_%j.err
...
LOGFILE=$LOGDIR/cpBias_17-18.log
...
-o DECam/calib/template/bias/17-18 \
-p $CP_PIPE_DIR/pipelines/DECam/cpBias.yaml \
-d "instrument='DECam' AND exposure.observation_type='zero' AND exposure.day_obs >= 20170701 AND exposure.day_obs <= 20170703" \
2>&1 | tee -a $LOGFILE
date | tee -a $LOGFILE
